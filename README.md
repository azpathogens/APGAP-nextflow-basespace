...
1. Run the previous steps from the [Local Nextflow Executor](#local-nextflow-executor) to setup gcloud, the basespace client, and populate variables.  Stop at the step to run the Nextflow pipeline and continue here.
